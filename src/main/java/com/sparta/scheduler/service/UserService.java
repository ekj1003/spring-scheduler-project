...
public class UserService {
    ...
    public void assignUsersToSchedule(ManagerUserRequestDto requestDto) {
        Schedule schedule = findSchedule(requestDto.getScheduleId());
        ArrayList<Long> managerUserList = requestDto.getManagerUserList();

        if(!Objects.equals(requestDto.getId(), schedule.getWriter().getId())) {
            throw new IllegalArgumentException("해당 일정의 작성자가 아닙니다.");
        }
